...
/* modify 150128 ryoung  fs_flags ->mapping
to set more information for journal io 
( transaction id, 
fsync id from ANDROTRACE , process id who call fsync()/fdatasync()
)
*/
...
int jbd2_journal_force_commit_nested(journal_t *journal)
{
	...
	if (need_to_start){
#ifdef CONFIG_ANDROTRACE
		jbd2_log_start_commit(journal, tid, journal->j_fs_mapping); /* 150207 modify ryoung */
#else
...
#ifdef CONFIG_ANDROTRACE  /* +150207 ryoung */
