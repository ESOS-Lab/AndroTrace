...
struct transaction_s
{
	...
	struct 	address_space 	*t_fs_mapping; /* 150128 ryoung */	
#endif

	/* Sequence number for this transaction [no locking] */
	tid_t			t_tid;      /* unsigned 16 (unsigned shrot) */  
...
#ifdef CONFIG_ANDROTRACE
	struct address_space 	*j_fs_mapping; /* +150207 ryoung to identify why journal is force commit */
#endif
